	...
	beforeEach(function () {
	  ...
	  jasmine.addMatchers({
	    toEqualHTML: function toEqualHTML() {
	      return {
	        compare: function compare(actual, expected, ignoreClassId) {
	    ...
	    toBeApproximately: function toBeApproximately() {
	      return {
	        compare: function compare(actual, expected, tolerance) {
	  ...
	  this.initialize = function (klass, html) {
	    var container = arguments.length <= 2 || arguments[2] === undefined ? _this.container : arguments[2];
	    ...
	    var scroll = new _scroll2.default(container, emitter);
...
/***/ function(module, exports, __webpack_require__) {
	...
	describe('Scroll', function () {
	  describe('descendant()', function () {
	    beforeEach(function () {
	      this.scroll = this.initialize(_scroll2.default, '<h1>01<em>23</em></h1><p><u>56</u><img></p>');
	    });
	
	    it('text', function () {
	      var _scroll$descendant = this.scroll.descendant(_parchment2.default.Leaf, 1);
	
	      var _scroll$descendant2 = _slicedToArray(_scroll$descendant, 2);
	
	      var leaf = _scroll$descendant2[0];
	      var offset = _scroll$descendant2[1];
	    ...
	    it('newline', function () {
	      var _scroll$descendant3 = this.scroll.descendant(_parchment2.default.Leaf, 4);
	
	      var _scroll$descendant4 = _slicedToArray(_scroll$descendant3, 2);
	
	      var leaf = _scroll$descendant4[0];
	      var offset = _scroll$descendant4[1];
	    ...
	    it('next line', function () {
	      var _scroll$descendant5 = this.scroll.descendant(_parchment2.default.Leaf, 5);
	
	      var _scroll$descendant6 = _slicedToArray(_scroll$descendant5, 2);
	
	      var leaf = _scroll$descendant6[0];
	      var offset = _scroll$descendant6[1];
	    ...
	    it('embed', function () {
	      var _scroll$descendant7 = this.scroll.descendant(_parchment2.default.Leaf, 7);
	
	      var _scroll$descendant8 = _slicedToArray(_scroll$descendant7, 2);
	
	      var leaf = _scroll$descendant8[0];
	      var offset = _scroll$descendant8[1];
	    ...
	    it('end of document', function () {
	      var _scroll$descendant9 = this.scroll.descendant(_parchment2.default.Leaf, 9);
	
	      var _scroll$descendant10 = _slicedToArray(_scroll$descendant9, 2);
	
	      var leaf = _scroll$descendant10[0];
	      var offset = _scroll$descendant10[1];
	...
	describe('Editor', function () {
	  describe('delta', function () {
	    ...
	    it('full document', function () {
	      ...
	      var expected = editor.scroll.domNode.innerHTML;
	      expect(editor.getDelta()).toEqual(new _delta2.default().insert('Quill Rich Text Editor').insert('\n', { header: 2 }).insert('\nQuill is a free, ').insert('open source', { link: 'https://github.com/quilljs/quill/' }).insert(' WYSIWYG editor built for the modern web.\n\nFast and lightweight').insert('\n', { list: 'bullet' }).insert('Semantic markup').insert('\n', { list: 'bullet' }).insert('Standardized HTML between browsers').insert('\n', { list: 'bullet' }).insert('Cross browser support including Chrome, Firefox, Safari, and IE 9+').insert('\n', { list: 'bullet' }).insert('\n').insert({ image: 'http://quilljs.com/images/quill-photo.jpg' }).insert('\n', { align: 'center' }).insert('Download Quill', { size: 'large', link: 'https://github.com/quilljs/quill/releases/download/v0.20.0/quill.tar.gz' }).insert('\n', { align: 'center' }).insert('\n'));
	  ...
	  describe('applyDelta', function () {
	    ...
	    it('attributed insert', function () {
	      var editor = this.initialize(_editor2.default, '<p></p>');
	      editor.applyDelta(new _delta2.default().insert('01', { bold: true }));
	  ...
	  describe('delete', function () {
	    it('inner node', function () {
	      var editor = this.initialize(_editor2.default, '<p><em><strong>0123</strong></em></p>');
	  ...
	  describe('getFormat', function () {
	    ...
	    it('cursor', function () {
	      var editor = this.initialize(_editor2.default, '<h1><em><strong>0123</strong></em></h1><h2><u>5678</u></h2>');
	      expect(editor.getFormat(2)).toEqual({ bold: true, italic: true, header: 1 });
	    });
	
	    it('cursor with preformat', function () {
	      var _initialize = this.initialize([_editor2.default, _selection2.default], '<h1><em><strong>0123</strong></em></h1>');
	...
	describe('Selection', function () {
	  ...
	  describe('findLeaf', function () {
	    it('text', function () {
	      ...
	      var _findLeaf = (0, _selection.findLeaf)(scroll, 2);
	    ...
	    it('precise', function () {
	      ...
	      var _findLeaf3 = (0, _selection.findLeaf)(scroll, 3);
	
	      var _findLeaf4 = _slicedToArray(_findLeaf3, 2);
	
	      var leaf = _findLeaf4[0];
	      var offset = _findLeaf4[1];
	    ...
	    it('newline', function () {
	      ...
	      var _findLeaf5 = (0, _selection.findLeaf)(scroll, 4);
	    ...
	    it('cursor', function () {
	      ...
	      var _findLeaf7 = (0, _selection.findLeaf)(this.selection.scroll, 2);
	
	      var _findLeaf8 = _slicedToArray(_findLeaf7, 2);
	
	      var leaf = _findLeaf8[0];
	      var offset = _findLeaf8[1];
	    ...
	    it('beyond document', function () {
	      ...
	      var _findLeaf9 = (0, _selection.findLeaf)(scroll, 10);
	
	      var _findLeaf10 = _slicedToArray(_findLeaf9, 2);
	
	      var leaf = _findLeaf10[0];
	      var offset = _findLeaf10[1];
	  ...
	  describe('getRange()', function () {
	    ...
	    it('nested text node', function () {
	      ...
	      selection.setNativeRange(this.container.querySelector('strong').firstChild, 1, this.container.querySelector('u').firstChild, 1);
	  ...
	  describe('format()', function () {
	    ...
	    it('split nodes', function () {
	      ...
	      expect(this.container.innerHTML).toEqualHTML('\n        <p>\n          <strong>01</strong>\n          <em><strong><span class="ql-cursor">' + _cursor2.default.CONTENTS + '</span></strong></em>\n          <strong>23</strong>\n        </p>\n      ');
	    });
	...
	describe('Events', function () {
	  describe('Editor', function () {
	    ...
	    it('user text insert', function (callback) {
	      ...
	      this.editor.emitter.on(_emitter2.default.events.TEXT_CHANGE, function (delta, old, source) {
	        expect(delta).toEqual(new _delta2.default().retain(2).insert('!'));
	        expect(old).toEqual(new _delta2.default().insert('0123\n'));
	        expect(source).toEqual(_emitter2.default.sources.USER);
	        callback();
	      });
	    });
	  });
...
/***/ function(module, exports, __webpack_require__) {
	...
	describe('Quill', function () {
	  beforeEach(function () {
	    this.quill = this.initialize(_quill2.default, '<p>01234567</p>');
	  });
	
	  describe('deleteText', function () {
	    it('(index, length)', function (done) {
	      this.quill.emitter.on(_emitter2.default.events.TEXT_CHANGE, function (change, oldDelta, source) {
	        expect(change).toEqual(new _delta2.default().retain(1).delete(2));
	        expect(oldDelta).toEqual(new _delta2.default().insert('01234567\n'));
	        expect(source).toEqual(_emitter2.default.sources.API);
	        done();
	      });
	  ...
	  xdescribe('selection preservation', function () {
	    beforeEach(function () {
	      this.quill = this.initialize(_quill2.default, '<p><strong>0123</strong><em>4567</em></p>');
	    });
	
	    it('format surround', function () {
	      this.quill.setSelection(1, 3);
	      this.quill.formatText(0, 4, 'italic', true);
	      expect(this.quill.getSelection()).toEqual(new _selection.Range(1, 3));
	    });
	    ...
	    it('user dom text change', function () {
	      ...
	      var textNode = this.quill.scroll.domNode.firstChild.firstChild.firstChild;
	      textNode.splitText(1);
	      textNode.parentNode.removeChild(textNode);
	      expect(this.quill.getSelection()).toEqual(new _selection.Range(1, 2));
	    });
	  });
	
	  describe('setContents()', function () {
	    it('should accept a delta', function () {
	      var delta = new _delta2.default().insert('test\n');
	    ...
	    it('should accept a json representation of a delta', function () {
	      ...
	      this.quill.setContents(delta);
	      expect(this.quill.getContents()).toEqual(new _delta2.default(delta));
	    });
	  });
	  ...
	  describe('insertEmbed', function () {
	    it('image', function (done) {
	      this.quill.emitter.once(_emitter2.default.events.TEXT_CHANGE, function (change, oldDelta, source) {
	        expect(change).toEqual(new _delta2.default().insert({ image: '/assets/favicon.png' }));
	        expect(oldDelta).toEqual(new _delta2.default().insert('01234567\n'));
	        expect(source).toEqual(_emitter2.default.sources.API);
	        done();
	      });
	      this.quill.insertEmbed(0, 'image', '/assets/favicon.png');
	      var expectedDelta = new _delta2.default().insert({ image: '/assets/favicon.png' }).insert('01234567\n');
	...
	describe('Formats', function () {
	  describe('Inline', function () {
	    it('definition', function () {
	      ...
	      var expected = new _delta2.default().insert('0', { bold: true }).insert('1', { italic: true }).insert('2', { strike: true }).insert('3', { underline: true }).insert('4', { link: 'http://quilljs.com/' }).insert('5', { code: true }).insert('6', { script: 'super' }).insert('7', { script: 'sub' }).insert('\n');
	    ...
	    it('inner node', function () {
	      ...
	      expect(editor.getDelta()).toEqual(new _delta2.default().insert('0', { italic: true }).insert('12', { italic: true, bold: true }).insert('3', { italic: true }).insert('\n'));
	    ...
	    it('outer node', function () {
	      ...
	      expect(editor.getDelta()).toEqual(new _delta2.default().insert('0', { bold: true }).insert('12', { italic: true, bold: true }).insert('3', { bold: true }).insert('\n'));
	      expect(this.container.innerHTML).toEqualHTML('\n        <p>\n          <strong>0</strong>\n          <em><strong>12</strong></em>\n          <strong>3</strong>\n        </p>');
	    });
	
	    it('overlap', function () {
	      var editor = this.initialize(_editor2.default, '<p>012</p>');
	      editor.formatText(0, 2, { bold: true });
	      editor.formatText(1, 2, { italic: true });
	      expect(editor.getDelta()).toEqual(new _delta2.default().insert('0', { bold: true }).insert('1', { bold: true, italic: true }).insert('2', { italic: true }).insert('\n'));
	      expect(this.container.innerHTML).toEqualHTML('\n        <p><strong>0</strong><em><strong>1</strong>2</em></p>\n      ');
	    });
	
	    it('ordering', function () {
	      var editor = this.initialize(_editor2.default, '<p>012</p><p>456</p>');
	      editor.formatText(0, 2, { bold: true });
	      editor.formatText(1, 2, { italic: true });
	      editor.formatText(5, 2, { italic: true });
	      editor.formatText(4, 2, { bold: true });
	      expect(editor.getDelta()).toEqual(new _delta2.default().insert('0', { bold: true }).insert('1', { italic: true, bold: true }).insert('2', { italic: true }).insert('\n').insert('4', { bold: true }).insert('5', { italic: true, bold: true }).insert('6', { italic: true }).insert('\n'));
	    ...
	    it('parts of multiple lines', function () {
	      ...
	      expect(editor.getDelta()).toEqual(new _delta2.default().insert('01', { italic: true }).insert('23', { italic: true, bold: true }).insert('\n').insert('56', { italic: true, bold: true }).insert('78', { italic: true }).insert('\n'));
	      expect(this.container.innerHTML).toEqualHTML('\n        <p><em>01<strong>23</strong></em></p>\n        <p><em><strong>56</strong>78</em></p>');
	    });
	
	    it('subscript exclusitivity', function () {
	      var editor = this.initialize(_editor2.default, '<p><sub>0123</sub></p>');
	      editor.formatText(1, 2, { script: 'super' });
	      expect(editor.getDelta()).toEqual(new _delta2.default().insert('0', { script: 'sub' }).insert('12', { script: 'super' }).insert('3', { script: 'sub' }).insert('\n'));
	      expect(this.container.innerHTML).toEqualHTML('<p><sub>0</sub><sup>12</sup><sub>3</sub></p>');
	    });
	
	    it('superscript exclusitivity', function () {
	      var editor = this.initialize(_editor2.default, '<p><sup>0123</sup></p>');
	      editor.formatText(1, 2, { script: 'sub' });
	      expect(editor.getDelta()).toEqual(new _delta2.default().insert('0', { script: 'super' }).insert('12', { script: 'sub' }).insert('3', { script: 'super' }).insert('\n'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	describe('Block Attributor', function () {
	  it('definition', function () {
	    var editor = this.initialize(_editor2.default, '\n      <h1>0</h1>\n      <h2>2</h2>\n      <h3>4</h3>\n      <ul>\n        <li>6</li>\n      </ul>\n      <ol>\n        <li>8</li>\n      </ol>');
	    expect(editor.getDelta()).toEqual(new _delta2.default().insert('0').insert('\n', { header: 1 }).insert('2').insert('\n', { header: 2 }).insert('4').insert('\n', { header: 3 }).insert('6').insert('\n', { list: 'bullet' }).insert('8').insert('\n', { list: 'ordered' }));
	  });
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	describe('Attributor', function () {
	  it('definition', function () {
	    ...
	    expect(editor.getDelta()).toEqual(new _delta2.default().insert('0123', { color: 'red', background: 'blue', size: 'large', font: 'monospace' }).insert('\n', { direction: 'rtl', align: 'center' }));
	  });
...
/***/ function(module, exports, __webpack_require__) {
	...
	describe('Formats', function () {
	  describe('Header', function () {
	    it('init', function () {
	      var editor = this.initialize(_editor2.default, '<h1>Header</h1><h2>Subheader</h2><h3>Subsubheader</h3>');
	      expect(editor.getDelta()).toEqual(new _delta2.default().insert('Header').insert('\n', { header: 1 }).insert('Subheader').insert('\n', { header: 2 }).insert('Subsubheader').insert('\n', { header: 3 }));
	    });
...
/***/ function(module, exports, __webpack_require__) {
	...
	describe('List', function () {
	  ...
	  it('empty line interop', function () {
	    var editor = this.initialize(_editor2.default, '<ol><li></li></ol>');
	  ...
	  describe('undo/redo', function () {
	    ...
	    it('dont merge changes', function (done) {
	      ...
	      setTimeout(function () {
	        ...
	        expect(_this.quill.undoManager.stack.undo.length).toEqual(2);
	        done();
	    ...
	    it('transform api change', function () {
	      ...
	      this.quill.updateContents(new _delta2.default().retain(12).insert('es'), _quill2.default.sources.USER);
	      this.quill.updateContents(new _delta2.default().retain(4).delete(5), _quill2.default.sources.API);
	      this.quill.updateContents(new _delta2.default().retain(9).insert('!'), _quill2.default.sources.USER);
	      expect(this.quill.undoManager.stack.undo.length).toEqual(1);
	    ...
	    it('ignore remote changes', function () {
	      ...
	      this.quill.undoManager.options.userOnly = true;
	      this.quill.setText('\n');
	      this.quill.insertText(0, 'a', _quill2.default.sources.USER);
	      this.quill.insertText(1, 'b', _quill2.default.sources.API);
	      this.quill.insertText(2, 'c', _quill2.default.sources.USER);
	      this.quill.insertText(3, 'd', _quill2.default.sources.API);
	      this.quill.insertText(4, 'e', _quill2.default.sources.USER);
	      this.quill.insertText(5, 'f', _quill2.default.sources.API);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var icons = {
	  'align-center': __webpack_require__(72),
	  'align-justify': __webpack_require__(74),
	  'align-left': __webpack_require__(71),
	  'align-right': __webpack_require__(73),
	  'attachment': __webpack_require__(106),
	  'audio': __webpack_require__(107),
	  'authorship': __webpack_require__(108),
	  'background': __webpack_require__(75),
	  'blockquote': __webpack_require__(76),
	  'bold': __webpack_require__(77),
	  ...
	  'color': __webpack_require__(78),
	  'comment': __webpack_require__(111),
	  'direction-left': __webpack_require__(112),
	  'direction-right': __webpack_require__(113),
	  'dropdown': __webpack_require__(69),
	  'emoji': __webpack_require__(114),
	  'font': __webpack_require__(115),
	  'formula': __webpack_require__(116),
	  'hashtag': __webpack_require__(117),
	  'header': __webpack_require__(80),
	  'header-2': __webpack_require__(81),
	  'image': __webpack_require__(82),
	  'indent': __webpack_require__(118),
	  'italic': __webpack_require__(79),
	  'link': __webpack_require__(83),
	  'list-bullet': __webpack_require__(85),
	  'list-check': __webpack_require__(119),
	  'list-ordered': __webpack_require__(84),
	  'map': __webpack_require__(120),
	  'mention': __webpack_require__(121),
	  'outdent': __webpack_require__(122),
	  'redo': __webpack_require__(123),
	  'size-decrease': __webpack_require__(124),
	  'size-increase': __webpack_require__(125),
	  'size': __webpack_require__(126),
	  'spacing': __webpack_require__(127),
	  'speech': __webpack_require__(128),
	  'strike': __webpack_require__(86),
	  'subscript': __webpack_require__(129),
	  'superscript': __webpack_require__(130),
	  'table-border-all': __webpack_require__(131),
	  'table-border-bottom': __webpack_require__(132),
	  'table-border-left': __webpack_require__(133),
	  'table-border-none': __webpack_require__(134),
	  'table-border-outside': __webpack_require__(135),
	  'table-border-right': __webpack_require__(136),
	  'table-border-top': __webpack_require__(137),
	  'table-delete-cells': __webpack_require__(138),
	  'table-delete-columns': __webpack_require__(139),
	  'table-delete-rows': __webpack_require__(140),
	  'table-insert-cells': __webpack_require__(138),
	  'table-insert-columns': __webpack_require__(141),
	  'table-insert-rows': __webpack_require__(142),
	  'table-merge-cells': __webpack_require__(143),
	  'table-unmerge-cells': __webpack_require__(144),
	  'table': __webpack_require__(145),
	  'underline': __webpack_require__(87),
	  'undo': __webpack_require__(146),
	  'video': __webpack_require__(147)
	};
	...
	describe('Snow', function () {
	  it('icons', function () {
	    ...
	    Object.keys(icons).forEach(function (icon) {
	      ...
	      _this.container.firstChild.appendChild(button);
	    });
	  });
	});
...
/***/ function(module, exports) {
	...
	module.exports = "<svg viewbox=\"0 0 18 18\"> <path class=ql-stroke d=M6.6,11.4L9,9a1.456,1.456,0,0,1,2.059,2.059L7.971,14.147a2.912,2.912,0,0,1-4.118-4.118l6.177-6.177a2.912,2.912,0,0,1,4.118,4.118></path> </svg>";

/***/ },
/* 107 */
/***/ function(module, exports) {

	module.exports = "<svg viewbox=\"0 0 18 18\"> <ellipse class=ql-fill cx=10.5 cy=14 rx=2.5 ry=2></ellipse> <path class=ql-stroke d=M12,14V3c0,1.5,3,2.021,3,5></path> <path class=ql-fill d=M7,4A5,5,0,0,0,7,14a3.191,3.191,0,0,1,3-2.957V5.023A4.955,4.955,0,0,0,7,4ZM4.06,8.412a0.5,0.5,0,0,1-.49.4,0.485,0.485,0,0,1-.1-0.01,0.5,0.5,0,0,1-.393-0.588A3.98,3.98,0,0,1,6.216,5.079a0.5,0.5,0,0,1,.2.98A2.985,2.985,0,0,0,4.06,8.412ZM7,10A1,1,0,1,1,8,9,1,1,0,0,1,7,10Z></path> </svg>";

/***/ },
/* 108 */
/***/ function(module, exports) {

	module.exports = "<svg viewbox=\"0 0 18 18\"> <line class=ql-stroke x1=3 x2=15 y1=15 y2=15></line> <path class=\"ql-fill ql-stroke\" d=M9,8H9a3,3,0,0,1,3,3v0a0,0,0,0,1,0,0H6a0,0,0,0,1,0,0v0A3,3,0,0,1,9,8Z></path> <path class=\"ql-even ql-fill\" d=M11,5.01C11,6.021,10,9,9,9S7,6.021,7,5.01c0-1.651.292-2.99,2-2.99S11,3.359,11,5.01Z></path> </svg>";
...
/***/ function(module, exports) {
	...
	module.exports = "<svg viewbox=\"0 0 18 18\"> <path class=ql-stroke d=M9,3C5.686,3,3,5.239,3,8a4.669,4.669,0,0,0,2,3.719V15l3.094-2.063A7.186,7.186,0,0,0,9,13c3.314,0,6-2.239,6-5S12.314,3,9,3Z></path> </svg>";
...
/***/ function(module, exports) {
	...
	module.exports = "<svg viewbox=\"0 0 18 18\"> <circle class=ql-fill cx=7 cy=7 r=1></circle> <circle class=ql-fill cx=11 cy=7 r=1></circle> <path class=ql-stroke d=M7,10a2,2,0,0,0,4,0H7Z></path> <circle class=ql-stroke cx=9 cy=9 r=6></circle> </svg>";

/***/ },
/* 115 */
/***/ function(module, exports) {

	module.exports = "<svg viewbox=\"0 0 18 18\"> <polyline class=ql-stroke points=\"3.5 14 7 4 10.5 14\"></polyline> <line class=ql-stroke x1=9.45 x2=4.55 y1=11 y2=11></line> <path class=ql-fill d=M13.636,5.013a4.016,4.016,0,0,0-1.863.472,0.42,0.42,0,0,0-.179.629l0.112,0.214a0.418,0.418,0,0,0,.625.191,2.557,2.557,0,0,1,1.183-.326A0.933,0.933,0,0,1,14.573,7.2V7.338H14.339c-1.272,0-3.325.281-3.325,1.954A1.75,1.75,0,0,0,12.9,11.011a2.072,2.072,0,0,0,1.785-1.078h0.022a1.132,1.132,0,0,0-.022.247V10.4a0.412,0.412,0,0,0,.457.472h0.379A0.416,0.416,0,0,0,15.99,10.4V7.293A2.121,2.121,0,0,0,13.636,5.013Zm0.948,3.4a1.452,1.452,0,0,1-1.305,1.505,0.775,0.775,0,0,1-.859-0.753c0-.854,1.216-0.966,1.93-0.966h0.234V8.416Z></path> </svg>";
...
/***/ function(module, exports) {
	...
	module.exports = "<svg viewbox=\"0 0 18 18\"> <line class=ql-stroke x1=7 x2=6 y1=3 y2=15></line> <line class=ql-stroke x1=12 x2=11 y1=3 y2=15></line> <line class=ql-stroke x1=3.75 x2=14.75 y1=7 y2=7></line> <line class=ql-stroke x1=3.25 x2=14.25 y1=11 y2=11></line> </svg>";
...
/***/ function(module, exports) {
	...
	module.exports = "<svg viewbox=\"0 0 18 18\"> <polyline class=ql-stroke points=\"3.5 14 7 4 10.5 14\"></polyline> <line class=ql-stroke x1=9.45 x2=4.55 y1=11 y2=11></line> <rect class=ql-fill height=5 rx=0.5 ry=0.5 transform=\"translate(20 -7) rotate(90)\" width=1 x=13 y=4></rect> </svg>";

/***/ },
/* 125 */
/***/ function(module, exports) {

	module.exports = "<svg viewbox=\"0 0 18 18\"> <polyline class=ql-stroke points=\"3.5 14 7 4 10.5 14\"></polyline> <line class=ql-stroke x1=9.45 x2=4.55 y1=11 y2=11></line> <rect class=ql-fill height=5 rx=0.5 ry=0.5 width=1 x=13 y=4></rect> <rect class=ql-fill height=5 rx=0.5 ry=0.5 transform=\"translate(20 -7) rotate(90)\" width=1 x=13 y=4></rect> </svg>";

/***/ },
/* 126 */
/***/ function(module, exports) {

	module.exports = "<svg viewbox=\"0 0 18 18\"> <polyline class=ql-stroke points=\"3.5 14 7 4 10.5 14\"></polyline> <line class=ql-stroke x1=9.45 x2=4.55 y1=11 y2=11></line> <path class=ql-fill d=M12.09,7.55l1.7-1.473a0.337,0.337,0,0,1,.429,0l1.7,1.473A0.261,0.261,0,0,1,15.7,8H12.3A0.261,0.261,0,0,1,12.09,7.55Z></path> <path class=ql-fill d=M12.09,10.45l1.7,1.473a0.337,0.337,0,0,0,.429,0l1.7-1.473A0.261,0.261,0,0,0,15.7,10H12.3A0.261,0.261,0,0,0,12.09,10.45Z></path> </svg>";

/***/ },
/* 127 */
/***/ function(module, exports) {

	module.exports = "<svg viewbox=\"0 0 18 18\"> <line class=ql-stroke x1=10 x2=15 y1=4 y2=4></line> <line class=ql-stroke x1=10 x2=15 y1=9 y2=9></line> <line class=ql-stroke x1=10 x2=15 y1=14 y2=14></line> <polygon class=\"ql-fill ql-stroke\" points=\"3 5 5 3 7 5 3 5\"></polygon> <line class=ql-stroke x1=5 x2=5 y1=7 y2=5></line> <polygon class=\"ql-fill ql-stroke\" points=\"3 13 5 15 7 13 3 13\"></polygon> <line class=ql-stroke x1=5 x2=5 y1=11 y2=13></line> </svg>";

/***/ },
/* 128 */
/***/ function(module, exports) {

	module.exports = "<svg viewbox=\"0 0 18 18\"> <path class=ql-stroke d=M5,8a4,4,0,0,0,8,0></path> <line class=ql-stroke x1=6 x2=12 y1=15 y2=15></line> <line class=ql-stroke x1=9 x2=9 y1=12 y2=15></line> <rect class=ql-fill height=8 rx=2 ry=2 width=4 x=7 y=2></rect> </svg>";
...
/***/ function(module, exports) {
	...
	module.exports = "<svg viewbox=\"0 0 18 18\"> <rect class=ql-stroke-mitter height=12 width=12 x=3 y=3></rect> <line class=ql-stroke-mitter x1=9 x2=9 y1=3 y2=15></line> <line class=ql-stroke-mitter x1=15 x2=3 y1=9 y2=9></line> </svg>";

/***/ },
/* 132 */
/***/ function(module, exports) {

	module.exports = "<svg viewbox=\"0 0 18 18\"> <g class=\"ql-fill ql-transparent\"> <rect height=2 transform=\"translate(18 -12) rotate(90)\" width=2 x=14 y=2></rect> <rect height=2 transform=\"translate(21 -9) rotate(90)\" width=2 x=14 y=5></rect> <rect height=2 transform=\"translate(24 -6) rotate(90)\" width=2 x=14 y=8></rect> <rect height=2 transform=\"translate(30 0) rotate(90)\" width=2 x=14 y=14></rect> <rect height=2 transform=\"translate(27 -3) rotate(90)\" width=2 x=14 y=11></rect> <rect height=2 transform=\"translate(6 0) rotate(90)\" width=2 x=2 y=2></rect> <rect height=2 transform=\"translate(9 3) rotate(90)\" width=2 x=2 y=5></rect> <rect height=2 transform=\"translate(12 6) rotate(90)\" width=2 x=2 y=8></rect> <rect height=2 transform=\"translate(18 12) rotate(90)\" width=2 x=2 y=14></rect> <rect height=2 transform=\"translate(15 9) rotate(90)\" width=2 x=2 y=11></rect> </g> <line class=ql-stroke-mitter x1=2 x2=16 y1=15 y2=15></line> <g class=\"ql-fill ql-transparent\"> <rect height=2 width=2 x=5 y=2></rect> <rect height=2 width=2 x=8 y=2></rect> <rect height=2 width=2 x=11 y=2></rect> <rect height=2 width=2 x=5 y=14></rect> <rect height=2 width=2 x=8 y=14></rect> <rect height=2 width=2 x=8 y=11></rect> <rect height=2 width=2 x=8 y=8></rect> <rect height=2 width=2 x=8 y=5></rect> <rect height=2 transform=\"translate(15 3) rotate(90)\" width=2 x=5 y=8></rect> <rect height=2 transform=\"translate(21 -3) rotate(90)\" width=2 x=11 y=8></rect> <rect height=2 width=2 x=11 y=14></rect> </g> </svg>";

/***/ },
/* 133 */
/***/ function(module, exports) {

	module.exports = "<svg viewbox=\"0 0 18 18\"> <g class=\"ql-fill ql-transparent\"> <rect height=2 transform=\"translate(30 6) rotate(180)\" width=2 x=14 y=2></rect> <rect height=2 transform=\"translate(24 6) rotate(180)\" width=2 x=11 y=2></rect> <rect height=2 transform=\"translate(18 6) rotate(180)\" width=2 x=8 y=2></rect> <rect height=2 transform=\"translate(6 6) rotate(180)\" width=2 x=2 y=2></rect> <rect height=2 transform=\"translate(12 6) rotate(180)\" width=2 x=5 y=2></rect> <rect height=2 transform=\"translate(30 30) rotate(180)\" width=2 x=14 y=14></rect> <rect height=2 transform=\"translate(24 30) rotate(180)\" width=2 x=11 y=14></rect> <rect height=2 transform=\"translate(18 30) rotate(180)\" width=2 x=8 y=14></rect> <rect height=2 transform=\"translate(6 30) rotate(180)\" width=2 x=2 y=14></rect> <rect height=2 transform=\"translate(12 30) rotate(180)\" width=2 x=5 y=14></rect> </g> <line class=ql-stroke-mitter x1=3 x2=3 y1=16 y2=2></line> <g class=\"ql-fill ql-transparent\"> <rect height=2 transform=\"translate(3 27) rotate(-90)\" width=2 x=14 y=11></rect> <rect height=2 transform=\"translate(6 24) rotate(-90)\" width=2 x=14 y=8></rect> <rect height=2 transform=\"translate(9 21) rotate(-90)\" width=2 x=14 y=5></rect> <rect height=2 transform=\"translate(-9 15) rotate(-90)\" width=2 x=2 y=11></rect> <rect height=2 transform=\"translate(-6 12) rotate(-90)\" width=2 x=2 y=8></rect> <rect height=2 transform=\"translate(-3 15) rotate(-90)\" width=2 x=5 y=8></rect> <rect height=2 transform=\"translate(0 18) rotate(-90)\" width=2 x=8 y=8></rect> <rect height=2 transform=\"translate(3 21) rotate(-90)\" width=2 x=11 y=8></rect> <rect height=2 transform=\"translate(18 24) rotate(180)\" width=2 x=8 y=11></rect> <rect height=2 transform=\"translate(18 12) rotate(180)\" width=2 x=8 y=5></rect> <rect height=2 transform=\"translate(-3 9) rotate(-90)\" width=2 x=2 y=5></rect> </g> </svg>";

/***/ },
/* 134 */
/***/ function(module, exports) {

	module.exports = "<svg viewbox=\"0 0 18 18\"> <g class=\"ql-fill ql-transparent\"> <rect height=2 width=2 x=2 y=2></rect> <rect height=2 width=2 x=5 y=2></rect> <rect height=2 width=2 x=8 y=2></rect> <rect height=2 width=2 x=14 y=2></rect> <rect height=2 width=2 x=11 y=2></rect> <rect height=2 width=2 x=2 y=14></rect> <rect height=2 width=2 x=5 y=14></rect> <rect height=2 width=2 x=8 y=14></rect> <rect height=2 width=2 x=14 y=14></rect> <rect height=2 width=2 x=11 y=14></rect> <rect height=2 transform=\"translate(-9 15) rotate(-90)\" width=2 x=2 y=11></rect> <rect height=2 transform=\"translate(-6 12) rotate(-90)\" width=2 x=2 y=8></rect> <rect height=2 transform=\"translate(-3 9) rotate(-90)\" width=2 x=2 y=5></rect> <rect height=2 transform=\"translate(3 27) rotate(-90)\" width=2 x=14 y=11></rect> <rect height=2 transform=\"translate(6 24) rotate(-90)\" width=2 x=14 y=8></rect> <rect height=2 transform=\"translate(3 21) rotate(-90)\" width=2 x=11 y=8></rect> <rect height=2 transform=\"translate(0 18) rotate(-90)\" width=2 x=8 y=8></rect> <rect height=2 transform=\"translate(-3 15) rotate(-90)\" width=2 x=5 y=8></rect> <rect height=2 width=2 x=8 y=11></rect> <rect height=2 width=2 x=8 y=5></rect> <rect height=2 transform=\"translate(9 21) rotate(-90)\" width=2 x=14 y=5></rect> </g> </svg>";

/***/ },
/* 135 */
/***/ function(module, exports) {

	module.exports = "<svg viewbox=\"0 0 18 18\"> <defs> <style>.cls-1{opacity:.4}.cls-2{fill:#444}.cls-3{fill:none;stroke:#444;stroke-miterlimit:10;stroke-width:2px}</style> </defs> <g class=\"ql-fill ql-transparent\"> <rect height=2 width=2 x=2 y=2></rect> <rect height=2 width=2 x=5 y=2></rect> <rect height=2 width=2 x=8 y=2></rect> <rect height=2 width=2 x=14 y=2></rect> <rect height=2 width=2 x=11 y=2></rect> <rect height=2 width=2 x=2 y=14></rect> <rect height=2 width=2 x=5 y=14></rect> <rect height=2 width=2 x=8 y=14></rect> </g> <rect class=ql-stroke-mitter height=12 width=12 x=3 y=3></rect> <g class=\"ql-fill ql-transparent\"> <rect height=2 width=2 x=14 y=14></rect> <rect height=2 width=2 x=11 y=14></rect> <rect height=2 transform=\"translate(-9 15) rotate(-90)\" width=2 x=2 y=11></rect> <rect height=2 transform=\"translate(-6 12) rotate(-90)\" width=2 x=2 y=8></rect> <rect height=2 transform=\"translate(-3 9) rotate(-90)\" width=2 x=2 y=5></rect> <rect height=2 transform=\"translate(3 27) rotate(-90)\" width=2 x=14 y=11></rect> <rect height=2 transform=\"translate(6 24) rotate(-90)\" width=2 x=14 y=8></rect> <rect height=2 transform=\"translate(3 21) rotate(-90)\" width=2 x=11 y=8></rect> <rect height=2 transform=\"translate(0 18) rotate(-90)\" width=2 x=8 y=8></rect> <rect height=2 transform=\"translate(-3 15) rotate(-90)\" width=2 x=5 y=8></rect> <rect height=2 width=2 x=8 y=11></rect> <rect height=2 width=2 x=8 y=5></rect> <rect height=2 transform=\"translate(9 21) rotate(-90)\" width=2 x=14 y=5></rect> </g> </svg>";

/***/ },
/* 136 */
/***/ function(module, exports) {

	module.exports = "<svg viewbox=\"0 0 18 18\"> <g class=\"ql-fill ql-transparent\"> <rect height=2 width=2 x=2 y=2></rect> <rect height=2 width=2 x=5 y=2></rect> <rect height=2 width=2 x=8 y=2></rect> <rect height=2 width=2 x=14 y=2></rect> <rect height=2 width=2 x=11 y=2></rect> <rect height=2 width=2 x=2 y=14></rect> <rect height=2 width=2 x=5 y=14></rect> <rect height=2 width=2 x=8 y=14></rect> <rect height=2 width=2 x=14 y=14></rect> <rect height=2 width=2 x=11 y=14></rect> </g> <line class=ql-stroke-mitter x1=15 x2=15 y1=16 y2=2></line> <g class=\"ql-fill ql-transparent\"> <rect height=2 transform=\"translate(-9 15) rotate(-90)\" width=2 x=2 y=11></rect> <rect height=2 transform=\"translate(-6 12) rotate(-90)\" width=2 x=2 y=8></rect> <rect height=2 transform=\"translate(-3 9) rotate(-90)\" width=2 x=2 y=5></rect> <rect height=2 transform=\"translate(3 27) rotate(-90)\" width=2 x=14 y=11></rect> <rect height=2 transform=\"translate(6 24) rotate(-90)\" width=2 x=14 y=8></rect> <rect height=2 transform=\"translate(3 21) rotate(-90)\" width=2 x=11 y=8></rect> <rect height=2 transform=\"translate(0 18) rotate(-90)\" width=2 x=8 y=8></rect> <rect height=2 transform=\"translate(-3 15) rotate(-90)\" width=2 x=5 y=8></rect> <rect height=2 width=2 x=8 y=11></rect> <rect height=2 width=2 x=8 y=5></rect> <rect height=2 transform=\"translate(9 21) rotate(-90)\" width=2 x=14 y=5></rect> </g> </svg>";

/***/ },
/* 137 */
/***/ function(module, exports) {

	module.exports = "<svg viewbox=\"0 0 18 18\"> <g class=\"ql-fill ql-transparent\"> <rect height=2 transform=\"translate(-12 18) rotate(-90)\" width=2 x=2 y=14></rect> <rect height=2 transform=\"translate(-9 15) rotate(-90)\" width=2 x=2 y=11></rect> <rect height=2 transform=\"translate(-6 12) rotate(-90)\" width=2 x=2 y=8></rect> <rect height=2 transform=\"translate(0 6) rotate(-90)\" width=2 x=2 y=2></rect> <rect height=2 transform=\"translate(-3 9) rotate(-90)\" width=2 x=2 y=5></rect> <rect height=2 transform=\"translate(0 30) rotate(-90)\" width=2 x=14 y=14></rect> <rect height=2 transform=\"translate(3 27) rotate(-90)\" width=2 x=14 y=11></rect> <rect height=2 transform=\"translate(6 24) rotate(-90)\" width=2 x=14 y=8></rect> <rect height=2 transform=\"translate(12 18) rotate(-90)\" width=2 x=14 y=2></rect> <rect height=2 transform=\"translate(9 21) rotate(-90)\" width=2 x=14 y=5></rect> </g> <line class=ql-stroke-mitter x1=16 x2=2 y1=3 y2=3></line> <g class=\"ql-fill ql-transparent\"> <rect height=2 transform=\"translate(24 30) rotate(-180)\" width=2 x=11 y=14></rect> <rect height=2 transform=\"translate(18 30) rotate(-180)\" width=2 x=8 y=14></rect> <rect height=2 transform=\"translate(12 30) rotate(-180)\" width=2 x=5 y=14></rect> <rect height=2 transform=\"translate(24 6) rotate(-180)\" width=2 x=11 y=2></rect> <rect height=2 transform=\"translate(18 6) rotate(-180)\" width=2 x=8 y=2></rect> <rect height=2 transform=\"translate(18 12) rotate(-180)\" width=2 x=8 y=5></rect> <rect height=2 transform=\"translate(18 18) rotate(-180)\" width=2 x=8 y=8></rect> <rect height=2 transform=\"translate(18 24) rotate(-180)\" width=2 x=8 y=11></rect> <rect height=2 transform=\"translate(3 21) rotate(-90)\" width=2 x=11 y=8></rect> <rect height=2 transform=\"translate(-3 15) rotate(-90)\" width=2 x=5 y=8></rect> <rect height=2 transform=\"translate(12 6) rotate(-180)\" width=2 x=5 y=2></rect> </g> </svg>";

/***/ },
/* 138 */
/***/ function(module, exports) {

	module.exports = "<svg viewbox=\"0 0 18 18\"> <path class=ql-fill d=M15.707,7l1.146-1.146a0.5,0.5,0,1,0-.707-0.707L15,6.293,13.854,5.146a0.5,0.5,0,0,0-.707.707L14.293,7,13.146,8.146a0.5,0.5,0,1,0,.707.707L15,7.707l1.146,1.146a0.5,0.5,0,1,0,.707-0.707Z></path> <path class=ql-fill d=M6,5H3A1,1,0,0,0,2,6V8A1,1,0,0,0,3,9H6V5Z></path> <path class=ql-fill d=M10,5H7V9h3a1,1,0,0,0,1-1V6A1,1,0,0,0,10,5Z></path> <g class=\"ql-fill ql-transparent\"> <path d=M8,11h4V9a1,1,0,0,0-1-1H8v3Z></path> <path d=M7,11V8H4A1,1,0,0,0,3,9v2H7Z></path> <path d=M7,12H3v2a1,1,0,0,0,1,1H7V12Z></path> <path d=M8,12v3h3a1,1,0,0,0,1-1V12H8Z></path> <path d=M8,6h3a1,1,0,0,0,1-1V3a1,1,0,0,0-1-1H8V6Z></path> <path d=M4,6H7V2H4A1,1,0,0,0,3,3V5A1,1,0,0,0,4,6Z></path> </g> </svg>";

/***/ },
/* 139 */
/***/ function(module, exports) {

	module.exports = "<svg viewbox=\"0 0 18 18\"> <g class=\"ql-fill ql-transparent\"> <rect height=10 rx=1 ry=1 width=4 x=2 y=6></rect> <rect height=10 rx=1 ry=1 width=4 x=12 y=6></rect> </g> <rect class=ql-fill height=8 rx=1 ry=1 width=4 x=7 y=2></rect> <path class=ql-fill d=M9.707,13l1.146-1.146a0.5,0.5,0,0,0-.707-0.707L9,12.293,7.854,11.146a0.5,0.5,0,0,0-.707.707L8.293,13,7.146,14.146a0.5,0.5,0,1,0,.707.707L9,13.707l1.146,1.146a0.5,0.5,0,0,0,.707-0.707Z></path> </svg>";
...
/***/ function(module, exports) {
	...
	module.exports = "<svg viewbox=\"0 0 18 18\"> <rect class=ql-stroke height=4 width=12 x=3 y=7></rect> <path class=\"ql-fill ql-transparent\" d=M2,2V16H16V2H2ZM14,14H10V11H8v3H4V4H8V7h2V4h4V14Z></path> </svg>";

/***/ },
/* 144 */
/***/ function(module, exports) {

	module.exports = "<svg viewbox=\"0 0 18 18\"> <rect class=ql-stroke height=4 width=12 x=3 y=7></rect> <path class=\"ql-fill ql-transparent\" d=M2,2V16H16V2H2ZM14,14H10V11H8v3H4V4H8V7h2V4h4V14Z></path> <line class=ql-stroke x1=12 x2=12 y1=11 y2=7></line> <line class=ql-stroke x1=9 x2=9 y1=11 y2=7></line> <line class=ql-stroke x1=6 x2=6 y1=11 y2=7></line> </svg>";
